...
**rolln, Inc.**
A Delaware (USA) corporation, operator of the Axel service.
Mailing address for privacy and legal notices: **rolln, Inc., Delaware, United States (for our current postal address, contact legal@axelapp.ai)**
...
| Purpose | Contact |
| --- | --- |
| Privacy questions / data-subject requests | **privacy@axelapp.ai** |
...
| Purpose | Legal Basis |
| --- | --- |
| Creating/maintaining your account and Workspace; authenticating you; providing the Service | **Performance of a contract** (Art. 6(1)(b)) — with you or with the Customer you act for |
| Billing, invoicing, and subscription management | **Performance of a contract** (Art. 6(1)(b)); **legal obligation** for tax/accounting records (Art. 6(1)(c)) |
...
We may disclose Personal Data if we believe in good faith that doing so is reasonably necessary to: (a) comply with applicable law, regulation, legal process, or a lawful governmental request; (b) enforce our [Terms of Service](https://axelapp.ai/terms) and [Acceptable Use Policy](https://axelapp.ai/acceptable-use); (c) detect, prevent, or address fraud, security, or technical issues; or (d) protect the rights, property, or safety of rolln, our Customers, our users, or the public.
...
- **Audit-log data** of privileged actions is retained for **365 days by default** (configurable from 30 to 3,650 days) to support security, compliance, and dispute resolution, unless a longer period is required or permitted by law.
...
**Retention of Customer Data (for transparency only).** Separately from the controller Personal Data above, Axel applies retention windows to **Customer Data** — the webhook payloads, delivery records, and event data we process **as a processor on the Customer's instructions**, not as a controller. These windows are **not** governed by this Policy; they are governed by the [Data Processing Addendum](https://axelapp.ai/dpa) and are stated here only so you understand how the Service behaves. Current defaults are **30 days** for raw payloads (configurable from 0 to 30 days), **30 days** for delivery/event logs, **90 days** for dead-letter records (configurable from 1 to 365 days), and **30 days** for replay-request records (configurable from 1 to 90 days).

Customers can also use in-dashboard data-reset and retention controls, and submit erasure requests, to shorten or remove Customer Data within the limits described in our documentation and the [Data Processing Addendum](https://axelapp.ai/dpa).
...
- **Tenant isolation** — database rows, analytics records, object keys, and queue messages carry Workspace scope, and dashboard and service queries require the active Workspace identifier.
- **Declarative route evaluation** — customer-authored route filters and transforms are configuration evaluated without `eval` or customer JavaScript and without exposing network, filesystem, or process primitives to route configuration.
- **Auditing and rate limiting** — an append-only audit log of privileged actions, per-source rate limits, body-size and depth caps, and stable delivery identifiers for receiver-side deduplication.

These are measures we implement to reduce risk; as further described in our [Terms of Service](https://axelapp.ai/terms), no method of transmission or storage is perfectly secure, and we cannot guarantee a specific security outcome. If you believe your account or data has been compromised, contact **security@axelapp.ai** immediately.
...
Privacy: **privacy@axelapp.ai**
Legal notices: **legal@axelapp.ai**
General: **founders@axelapp.ai**
Mailing address: **rolln, Inc., Delaware, United States (for our current postal address, contact legal@axelapp.ai)**

For how we handle Customer Data on behalf of Customers, see our [Terms of Service / Master Subscription Agreement](https://axelapp.ai/terms) and [Data Processing Addendum](https://axelapp.ai/dpa). For our current list of Sub-processors, see the [Sub-processors](https://axelapp.ai/subprocessors) page. For details on cookies, see our [Cookie Policy](https://axelapp.ai/cookies).
