...
case "$worker_dir" in
  apps/ingest-worker)
    allowed_keys=" ADMIN_TOKEN DELIVERY_SHARED_SECRET SOURCE_LOOKUP_SHARED_SECRET ORDERING_KEY_HMAC_SECRET LEGACY_QUERY_TOKEN_SOURCES CLICKHOUSE_URL CLICKHOUSE_USER CLICKHOUSE_PASSWORD SENTRY_DSN "
    ;;
  apps/router-edge)
