...
Set `AXEL_IMAGE_TAG=0.1.1` in `.env.selfhost`, using the version you checked out,
...
For an existing v0.1.0 installation, see the [v0.1.1 upgrade notes](releases/v0.1.1.md).
